    ...
    public function get_content() {
        ...
        if(($now > get_config('block_nss', 'displayfrom')) && ($now < get_config('block_nss', 'displayto'))){
            ...
            if($DB->record_exists_sql('SELECT studentid FROM {nss} WHERE studentid = ?', array($USER->idnumber))){
                ...
                '<img src="/blocks/nss/images/nss.jpg" alt="Final year students: we want to know how you\'ve found your time at Solent. ' .
                'Complete the National Student Survey by Sunday 30 April and you could win a £400 Currys PC World voucher or one of ten £50 Amazon vouchers."' .
                ' class="img_nss"></a>';
            }
        }else{
            $this->content->text = '';
